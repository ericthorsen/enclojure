...
public class ClojureBreakpointUpdater extends LazyActionsManagerListener {

    private JPDADebugger debugger;

   public ClojureBreakpointUpdater (ContextProvider lookupProvider) {

        debugger = (JPDADebugger) lookupProvider.lookupFirst 
            (null, JPDADebugger.class);
        Context.createTimeStamp (debugger);
        ClojureBreakpointAnnotationListener bal = (ClojureBreakpointAnnotationListener) 
            DebuggerManager.getDebuggerManager ().lookupFirst 
            (null, ClojureBreakpointAnnotationListener.class);
        bal.updateClojureLineBreakpoints ();
    }
