...
public class ActionsPanel extends javax.swing.JPanel {
    ...
    public ActionsPanel (ClojureLineBreakpoint b) {
        breakpoint = b;
        initComponents ();
        ...
        switch (b.getSuspend ()) {
            case ClojureLineBreakpoint.SUSPEND_NONE:
                cbSuspend.setSelectedIndex (0);
                break;
            case ClojureLineBreakpoint.SUSPEND_EVENT_THREAD:
                cbSuspend.setSelectedIndex (1);
                break;
            case ClojureLineBreakpoint.SUSPEND_ALL:
